...
*/
	...
	define('REG_URL',	'http://www.namesfx.co.uk/index.php?option=com_hikashop&ctrl=product&task=updatecart&quantity=1&checkout=1&product_id=8');
...
/* 
	...
	#################################################################################################################
*/ 
echo '<img src="http://www.namesfx.co.uk/images/web_hosting_students.jpg" border="0" width="100%">';
	...
	function dispav($what)
	{
		...
		if (REG_LINK)
		{
			echo '<a href="'.REG_URL.'" target="_parent" onMouseOver="window.status=\''.STATUS_BAR_REGISTER_TEXT.' '.$what.'\';return true" onMouseOut="window.status=\'\';return true">'.LINK_REGISTER_TEXT.'</a>';
		}
		else
			echo '&nbsp;';
		echo '</td>
...
<table width="300" align="left" cellspacing="0" cellpadding="1" border="0" >
      <tr><td width="40%" align="left"><img src="http://www.namesfx.co.uk/images/web_hosting_students_price.jpg" border="0" width="250"></td><td>
